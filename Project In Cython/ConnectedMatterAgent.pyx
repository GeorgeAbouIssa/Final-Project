...
class ConnectedMatterAgent:
    ...
    def search(self, time_limit=30):
        ...
        # For disconnected goals, use the appropriate search method
        if self.is_goal_disconnected:
            # Choose between multithreaded and sequential approach
            # Default to multithreaded for better performance
