...
cdef class Visualizer:
    cdef public:
        ...
        bint animation_done
        int current_step
        bint animation_started
        object fig
        object ax
        object button_ax
        object button
        object text_annotation
        object controller  # Reference to controller
    
    def __init__(self, grid_size, path, start_positions, double animation_speed=0.05):
    ...
    cpdef draw_grid(self, bint highlight_initial=True, bint highlight_goal=False):
    ...
    cpdef update_text(self, str message, str color="black"):
    ...
    cpdef handle_button_click(self, event):
    ...
    cpdef animate_path(self):
        ...
        while self.current_step < len(self.path):
            ...
            # Show obstacles and goal during animation
    ...
    cpdef highlight_goal_shape(self, goal_positions):
    ...
    cpdef highlight_obstacles(self, obstacles):
    ...
    cpdef set_animation_speed(self, double speed):
